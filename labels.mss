...
@sans:"Proxima Nova","Arial Regular","DejaVu Sans Book";
@sans_bold:"Proxima Nova Bold","Arial Bold","DejaVu Sans Bold";
...
#country-labels[zoom>3] {
  ...
  [zoom=7] { text-size:12; text-character-spacing:0; }
  [zoom=8] { text-size:14; text-character-spacing:0; }
  [zoom>8] { text-size:16; text-character-spacing:0; }
